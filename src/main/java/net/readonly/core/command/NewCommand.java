...
import net.readonly.core.command.meta.Alias;
import net.readonly.core.command.meta.GuildOnly;
import net.readonly.core.command.meta.Help;
import net.readonly.core.command.meta.Name;
import net.readonly.core.command.meta.Permission;
...
public abstract class NewCommand {
    ...
    public NewCommand() {
        ...
        var c = clazz.getAnnotation(net.readonly.core.command.meta.Category.class);
        if (c == null) {
            this.category = null;
        } else {
